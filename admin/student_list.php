...
if(isset($_GET['delete'])){
    ...
    mysqli_query($conn, "DELETE FROM users1 WHERE id=$id AND role='student'");
...
<div class="col-md-5">
<input type="text" name="search" class="form-control" placeholder="Search student name or email"
value="<?= $search ?>">
</div>
...
<?php if(!empty($row['profile_image'])){ ?>
    ...
    <img src="../uploads/<?= htmlspecialchars(basename($row['profile_image'])) ?>"
         width="40"
         height="40"
...
<td>
<a href="student_list.php?delete=<?= $row['id'] ?>"
